...
{
    public class RegisterInputDto : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            if (string.IsNullOrWhiteSpace(Password))
                results.Add(ValidationError(nameof(Password), "Required"));
            ...
            if (!string.IsNullOrEmpty(Password) && Password.Length > 100)
                results.Add(ValidationError(nameof(Password), "ValidationErrorsMessage"));
            ...
            if (!string.IsNullOrEmpty(Password) && !IsValidPassword(Password))
                results.Add(ValidationError(nameof(Password), "InvalidPassword"));
